...
//     List<UploadTaskInfo> uploadTasks = [];
...
//         uploadTasks.add(uploadTaskInfo);

//         // Listen to snapshot events in a non-blocking way
...
//       emit(StorageManagerUploadTasks(tasks: uploadTasks));
//     }
//   }
// }
